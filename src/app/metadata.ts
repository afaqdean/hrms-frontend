...
const baseUrl = 'https://www.codehuddle.com';
export const defaultMetadata: Metadata = {
  title: {
    default: 'HRMS - Human Resource Management System',
    template: '%s | HRMS',
  },
  description: 'Advanced Human Resource Management System built with Next.js - streamline HR operations, employee management, and workforce analytics',
  keywords: [
    'hrms',
  ...
  authors: [
    {
      name: 'Code Huddle',
      url: 'https://github.com/Code-Huddle',
    },
  ],
  creator: 'Code Huddle',
  publisher: 'Code Huddle',
  formatDetection: {
    email: true,
    address: true,
    telephone: true,
  ...
  openGraph: {
    ...
    description: 'A comprehensive Human Resource Management System built with Next.js',
    siteName: 'HRMS',
    images: [
      {
